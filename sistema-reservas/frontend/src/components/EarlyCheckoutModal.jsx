        ...
        <div className="space-y-4">
          ...
          <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h4 className="font-semibold text-blue-900">Información de Estadía</h4>
            </div>
            <div className="grid grid-cols-2 gap-3 text-sm">
              ...
              <div>
                <p className="text-blue-700">Check-out original:</p>
                <p className="font-medium text-blue-900">
              ...
              {calculation && (
                <>
                  <div>
                    <p className="text-blue-700">Días totales:</p>
                    <p className="font-medium text-blue-900">{calculation.totalDays} días</p>
                  </div>
                  <div>
                    <p className="text-blue-700">Días utilizados:</p>
                    <p className="font-medium text-blue-900">{calculation.daysUsed} días</p>
                  </div>
                </>
              )}
            </div>
          ...
          {calculation && (
            <>
              <div className="p-4 bg-purple-50 border border-purple-200 rounded-lg">
                <h4 className="font-semibold text-purple-900 mb-3">📋 Política de Cancelación</h4>
                <div className="space-y-2 text-sm">
                  <div className="flex items-start gap-2">
                    <div className={`w-3 h-3 rounded-full mt-0.5 ${
                      !calculation.chargesCurrentDay ? 'bg-green-500' : 'bg-gray-300'
                    }`}></div>
                    <div>
                      <p className="font-medium text-purple-900">Antes de las 09:00 hrs</p>
                      <p className="text-purple-700">No se cobra el día actual</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-2">
                    <div className={`w-3 h-3 rounded-full mt-0.5 ${
                      calculation.chargesCurrentDay ? 'bg-red-500' : 'bg-gray-300'
                    }`}></div>
                    <div>
                      <p className="font-medium text-purple-900">Después de las 09:00 hrs</p>
                      <p className="text-purple-700">Se cobra el día completo</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h4 className="font-semibold text-green-900">Cálculo de Ajuste Financiero</h4>
                </div>
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    <span className="text-green-700">Valor por día:</span>
                    <span className="font-medium text-green-900">
                      {formatCLP(calculation.pricePerDay)}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-green-700">Días no utilizados:</span>
                    <span className="font-medium text-green-900">
                      {calculation.unusedDays} días
                    </span>
                  </div>
                  <div className="flex justify-between pt-2 border-t border-green-300">
                    <span className="text-green-700 font-semibold">Ajuste (devolución):</span>
                    <span className="font-bold text-green-600">
                      -{formatCLP(calculation.unusedAmount)}
                    </span>
                  </div>
                  <div className="flex justify-between pt-2 border-t border-green-300">
                    <span className="text-green-700 font-semibold">Nuevo total:</span>
