...
const RoomUpgradeModal = ({
  ...
  const loadAvailableUpgrades = async () => {
    try {
      ...
      console.error('Error al cargar upgrades:', error);
  ...
  const handleUpgrade = async () => {
    ...
    try {
      ...
      console.error('Error al realizar upgrade:', error);
        ...
        <div className="space-y-4">
          ...
          {isLoadingUpgrades && (
            <div className="flex items-center justify-center py-8">
              ...
              <span className="ml-2 text-gray-600">Cargando habitaciones disponibles...</span>
            </div>
          )}
          ...
          {!isLoadingUpgrades && error && !availableUpgrades.length && (
            <div className="bg-red-50 border border-red-200 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-semibold text-red-900">No hay upgrades disponibles</p>
