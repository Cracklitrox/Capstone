    ...
    const checkAvailableRoles = async () => {
      ...
      for (const [roleKey, roleLabel] of [
        ...
        try {
          ...
          const data = await cachedFetch(`users-by-role-${roleId}`, () => getUsersByRole(roleId));
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-start justify-between gap-2">
                                <div className="flex items-center gap-2 flex-wrap">
                                  <h3
                                    className={`text-base font-medium ${notification.status === 'unread' ? 'font-semibold' : ''
                                      }`}
                                  >
                                    {notification.title}
                                  </h3>
                              ...
                              <div className="flex gap-2 flex-wrap">
                                ...
                                {/* Botón "Ver quién leyó" SOLO en la pestaña "Enviados" - DESHABILITADO */}
                                {/* {activeTab === 'sent' && (
