  ...
  return (
    <div className="space-y-6">
              ...
              <div key={index} className="text-sm">
                <div className="flex justify-between">
                  <span className="text-foreground">
                    Habitación {rr.rooms?.room_number} {rr.rooms?.room_type?.name ? `(${rr.rooms.room_type.name})` : ''} - {nights}{' '}
      ...
      <div className="border-t pt-4 space-y-2">
        ...
        <div
          className={`flex justify-between text-lg font-bold pt-2 border-t ${pending > 0 ? 'text-destructive' : 'text-green-600'
            }`}
        >
          <span>Pendiente:</span>
