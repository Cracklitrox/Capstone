...
const QuickCheckOutButton = ({
  ...
  const ButtonComponent = (
    <Button
      ...
      className={`${className} ${!isPaidFully ? 'opacity-70 cursor-not-allowed bg-gray-400 dark:bg-gray-700 text-gray-700 dark:text-gray-400' : 'bg-green-600 hover:bg-green-700'}
        }`}
  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-2">
        {!isPaidFully && (
          <div className="inline-flex items-center gap-1 px-2 py-1 bg-red-100 dark:bg-red-900/30 border border-red-300 dark:border-red-700 rounded text-xs text-red-900 dark:text-red-200 font-medium">
