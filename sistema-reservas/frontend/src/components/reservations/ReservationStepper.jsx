...
import Step1SearchAvailability from "./steps/Step1SearchAvailability";
import Step2SelectRooms from "./steps/Step2SelectRooms";
import Step2_5GuestAssignment from "./steps/Step2_5GuestAssignment";
import Step3AdditionalServices from "./steps/Step3AdditionalServices";
import Step4MainGuest from "./steps/Step4MainGuest";
import Step5AdditionalGuests from "./steps/Step5AdditionalGuests";
              ...
              return (
                <React.Fragment key={step.id}>
                  ...
                  {index < STEPS.length - 1 && (
                    <div
                      className={`flex-1 h-1 mx-2 ${isCompleted ? "bg-green-500" : "bg-border"
                        }`}
                    />
                  )}
                </React.Fragment>
